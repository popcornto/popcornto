public class Array {
    ...
    public static void main(String[] args) {
        ...
        for (int element : doubleifcontainspositive(aref)) {
            System.out.println(element);

        //System.out.println(toString(new int[]{5, 17, 88, 88, 17, 5}));
        for (int element: copyStartingValues(aref)) {
            System.out.println(element);
        }
        for (int element: selectnegatives(new int[]{-1,1,-2,3,-4})) {
            System.out.println(element);
        }
        for (int element : addArrays(aref ,ass)) {
            System.out.println(element);
        }*/

        //System.out.println(countSequences(aref));
